...
import { setScheduleData } from "../../../../utils/api";
...
const ScheduleForm = ({
  ...
  const [submitCalculate, setSubmitCalculate] = useState<boolean>(false);
    ...
    <ScheduleFormWrapper>
      ...
      {!initialValuesCalculated ? (
        ...
        <Formik
          ...
          onSubmit={(values) => {
            setCalculateError("");
            setSubmitCalculate(true);
            setTimeout(() => {
              checkPresentersAndGames(values);
              setSubmitCalculate(false);
            }, 1000);
          }}
        >
            ...
            return (
              <Form onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <Button primary type="submit" disabled={submitCalculate}>
                    {submitCalculate ? (
